...
const getBgVariantStyle = (variant: ButtonProps["bgVariant"]) => {
  switch (variant) {
    ...
    case "success": 
      return "bg-green-500";
    case "outline": 
      return "bg-bg-transparent border-neutral-300 border-[0.5px]";
    default: 
    return "bg-[#0286ff]";
  }
};
...
const CustomButton = ({ onPress, title, bgVariant="primary", textVariant = "default", IconLeft, IconRight, className }: ButtonProps) => (
  <TouchableOpacity 
    onPress={ onPress } 
